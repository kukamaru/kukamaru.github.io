...
function notes() {
	...
	notes.show = function(){
		...
		setTimeout(function(){notesDiv.style.transition = "unset";},250)
...
dragElement(document.getElementById("notesDiv"));

function dragElement(elmnt) {
  var pos1 = 0, pos2 = 0, pos3 = 0, pos4 = 0;
  if (document.getElementById("notesDragger")) {
    // if present, the header is where you move the DIV from:
    document.getElementById("notesDragger").onmousedown = dragMouseDown;
  } else {
